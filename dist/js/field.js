...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-belongs-to-many-tags', __webpack_require__(5));
    Vue.component('detail-belongs-to-many-tags', __webpack_require__(8));
    Vue.component('form-belongs-to-many-tags', __webpack_require__(14));
});
...
var update = __webpack_require__(2)("6bd2fde8", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	computed: {
		values: function values() {
			...
			return this.field.value.map(function (val) {
				return val[_this.field.optionsLabel || 'name'];
			}).filter(function (val) {
				return !!val;
			});
		}
    ...
    [
      _c(
        ...
        _vm._l(_vm.values, function(value, i) {
          return _vm.values
            ? _c("span", { staticClass: "btmf_item" }, [_vm._v(_vm._s(value))])
            : _c("span", [_vm._v("—")])
        }),
        0
      )
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(19);
